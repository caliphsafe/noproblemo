...
export type PublicOrder={id:string;order_number:number;customer_public_name:string;fulfillment_status:string;created_at:string;items:{name:string;quantity:number}[]};
